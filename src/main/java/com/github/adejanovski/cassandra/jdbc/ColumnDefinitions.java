...
public class ColumnDefinitions implements Iterable<ColumnDefinitions.Definition> {
   ...
   * @return {@code true} if this metadata contains the column named {@code name}, {@code false} otherwise.
   */
   ...
   * @return the index of the first occurrence of {@code name} in this metadata if {@code contains(name)}, -1 otherwise.
   */
