...
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.BAD_AUTO_GEN;
...
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.BAD_HOLD_RSET;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.BAD_KEEP_RSET;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.BAD_TYPE_RSET;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.NO_GEN_KEYS;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.NO_INTERFACE;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.NO_MULTIPLE;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.NO_RESULTSET;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.WAS_CLOSED_STMT;
...
public class CassandraStatement extends AbstractStatement implements CassandraStatementExtras, Comparable<Object>, Statement {
  ...
  private static final String semiColonRegex = ";";
  ...
  private ArrayList<String> batchQueries;
  ...
  public CassandraStatement(CassandraConnection con) throws SQLException {
    this(con, null, ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, ResultSet.HOLD_CURSORS_OVER_COMMIT);
  }

  public CassandraStatement(CassandraConnection con, String cql, int resultSetType, int resultSetConcurrency) throws SQLException {
    this(con, cql, resultSetType, resultSetConcurrency, ResultSet.HOLD_CURSORS_OVER_COMMIT);
  }

  public CassandraStatement(CassandraConnection con, String cql, int resultSetType, int resultSetConcurrency,
