 ...
 */
package com.github.adejanovski.cassandra.jdbc.session;
...
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.TAG_LOADBALANCING_POLICY;
...
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.TAG_RECONNECT_POLICY;
import static com.github.adejanovski.cassandra.jdbc.utils.Utils.TAG_RETRY_POLICY;
...
import com.github.adejanovski.cassandra.jdbc.codec.DateCodec;
 ...
 *
 * This class uses reference counting to track if active CassandraConnections still use the Session. When the last CassandraConnection has closed, the Session gets closed.
 */
public class SessionHolder {
  ...
  public SessionHolder(Map<String, String> params, LoadingCache<Map<String, String>, SessionHolder> parentCache) throws SQLException {
  ...
  private Session createSession(Properties properties) throws SQLException {
    ...
    List<TypeCodec<?>> codecs = new ArrayList<>();
    ...
    codecs.add(new DateCodec(TypeCodec.date(), Date.class));
