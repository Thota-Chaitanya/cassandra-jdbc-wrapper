...
import com.github.adejanovski.cassandra.jdbc.connection.ManagedConnection;
...
public class ManagedPreparedStatement extends AbstractStatement implements PreparedStatement {
  ...
  public ManagedPreparedStatement(PooledCassandraConnection pooledCassandraConnection, ManagedConnection managedConnection,
  ...
  @Override
  public int getQueryTimeout() throws SQLNonTransientConnectionException {
    checkNotClosed();
